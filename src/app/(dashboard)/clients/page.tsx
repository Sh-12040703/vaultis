...
import { UserPlus, Phone, Mail, FileSpreadsheet, CalendarDays } from 'lucide-react'
            ...
            {allClients.map((client) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="bg-slate-700 text-slate-300 text-xs font-medium px-2.5 py-1 rounded-full">
                    {client.policyCount} {client.policyCount === 1 ? 'policy' : 'policies'}
                  </div>
                </div>
